...
created a method that will accept an int array and return the smallest number from the array
     */
    ...
    create a method that will accept an iint array and return the biggest number from the array
