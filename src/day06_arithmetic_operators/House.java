...
public class House {
    public static void main(String[] args) {
        ...
        String houseInfo = "The " + houseType + " on " + address + ", " + zipcode + " costs $" + costOfHouse + "\nThe " + houseType + " has " + numberOfBathrooms + " bedrooms, " + numberOfBathrooms + " bathrooms, " + numberOfKitchens + " kitchens.\nIt also includes a basement: " + hasBasement + ", has an attic: " + hasAttic + ", has a pool: " + hasPool + " and is on sale: " + isOnSale + ", and has a park: " + hasPark + ".\nThe schools in the area have a rating of " + schoolRating + ".";

        System.out.println(houseInfo);

//         approach 2:
//
//        String houseType = "Penthouse", address = "129481";
//        int numberOfBedrooms, numberOfBathrooms = 3, numberOfKitchens = 2, zipcode = 219124;
//        boolean hasBasement = false, hasAttic = false, hasPool = true, isOnSale = false, hasPark = true;
//        double costOfHouse = 1_000_000.99, schoolRating = 4.6;  // 4.5  |  1000000.99;
//
//
