...
public class CastingExamples {
    public static void main(String[] args) {
        ...
        System.out.println(letter2);  //65 ascii number  letter2
        System.out.println((int)letter);  //65 because of casting (int)letter
        System.out.println((char)66);  // result is B because ascii value is B
        System.out.println((int)' '); //Ascii value of 'space' which is 32
