    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 2; j++) {
                ...
                //break; if the break is here, the outer loop will iterate fully, but the inner loop will execute the iteration and then the break runs, which stops the inner loop. Code resumes after the outer loop iterations finishes
            }
