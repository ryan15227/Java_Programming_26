    ...
    public static void main(String[] args) {
        ...
        if(budget > 0 && budget < 300_001){
          ...
          if(isAvailable) {
              ...
              ad += "\nGated: " + (gated ? "Yes" : "No");  // this line means if the gated boolean is true it will concatenate "yes" into the ad, but if the gated boolean is false it will concatenate "no" into the ad
              ad += "\n" + "They allow pets: " + (allowPets ? "They allow pets" : "They don't allow pets");
