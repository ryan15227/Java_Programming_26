...
public class Groups {
    public static void main(String[] args) {
        ...
        //[[null, null, null,], [null, null, null], [null, null, null], [null, null, null]] --> 4 innder arrays that each haeve a size of 3
        ...
        cydeo[2] = new String[]{"Mustafa", "Lima"}; // syntax used to create an array without reference
        System.out.println(Arrays.deepToString(cydeo));
